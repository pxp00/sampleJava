package mingri.tst16_1;

import java.lang.reflect.Constructor;
import java.lang.reflect.Modifier;

//reqs: reflect constructor
//flow: new object -> getClass -> getDeclaredConstructors, getModifiers, getParameterTypes, getExceptionTypes, newInstance(run constructor)
		...
		for (int i = 0; i < declaredConstructors.length; i++) {
			...
			while (example2 == null) {
				try {
					...
					e.printStackTrace(); // private constructor couldn't access
